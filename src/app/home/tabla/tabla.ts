...
export class Tabla implements OnInit {
  ...
  ngOnInit(): void {
    this.articulos = [
      { clave: "P800", nombre: "Crema" },
      { clave: "P801", nombre: "Crema 1" },
      { clave: "P802", nombre: "Crema 2" },
      { clave: "P804", nombre: "Crema 3" },
      { clave: "P805", nombre: "Crema 4" },
      { clave: "P803", nombre: "Crema 5" },
      { clave: "P806", nombre: "Crema 6" },
      { clave: "P807", nombre: "Crema 7" },
      { clave: "P808", nombre: "Crema 8" },
      { clave: "P809", nombre: "Crema 9" },
      { clave: "P810", nombre: "Crema 10" },
      { clave: "P811", nombre: "Crema 11" },
      { clave: "P812", nombre: "Crema 12" },
      { clave: "P813", nombre: "Crema 13" },
      { clave: "P814", nombre: "Crema 14" },
      { clave: "P815", nombre: "Crema 15" },
      { clave: "P816", nombre: "Crema 16" },
      { clave: "P817", nombre: "Crema 17" },
      { clave: "P818", nombre: "Crema 18" },
      { clave: "P819", nombre: "Crema 19" },
    ];
    this.cargarTabla();
  }
